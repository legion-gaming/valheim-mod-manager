...
public interface IThunderstoreService
{
    ...
    Task<ThunderstoreModVersion> GetModAsync(string dependencyString, CancellationToken cancellationToken = default);
    Task<IReadOnlyList<ThunderstoreModVersion>> GetInstalledModsAsync(string profileName, CancellationToken cancellationToken = default);
